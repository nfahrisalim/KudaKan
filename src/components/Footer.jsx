  ...
  const socialLinks = [
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987c6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.611-3.197-1.559-.748-.948-.748-2.122 0-3.07.749-.948 1.9-1.559 3.197-1.559 1.297 0 2.448.611 3.197 1.559.748.948.748 2.122 0 3.07-.749.948-1.9 1.559-3.197 1.559zm7.718 0c-1.297 0-2.448-.611-3.197-1.559-.748-.948-.748-2.122 0-3.07.749-.948 1.9-1.559 3.197-1.559 1.297 0 2.448.611 3.197 1.559.748.948.748 2.122 0 3.07-.749.948-1.9 1.559-3.197 1.559z"/>
        </svg>
      ),
      href: '#'
    },
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-4">
              <HorseLogo className="w-8 h-8" fillColor="fill-kudakan-red" />
              <span className="font-bold text-xl">Kuda<span className="text-kudakan-red">kan</span></span>
            </div>
